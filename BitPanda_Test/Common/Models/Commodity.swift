...
//
//   let commodity = try? newJSONDecoder().decode(Commodity.self, from: jsonData)
//   let commodityAttributes = try? newJSONDecoder().decode(CommodityAttributes.self, from: jsonData)
